...
export default class Schema {
    ...
    _parse_node(nodeObj) {
        ...
        let domainInfo = Visualizer.domain_meta_manager.parse_node_metadata(nodeObj);
    ...
    _parse_enum_nodes(enumObj) {
        ...
        let domainInfo = Visualizer.domain_meta_manager.parse_node_metadata(enumObj, this._enumDefaultDomain.get(enumObj.name));
